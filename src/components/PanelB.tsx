...
export const PanelB: React.FC = () => {
  ...
  const handleConfirmCategoryAndBuy = (catId: string) => {
    if (!selectedWish) return;
    fulfillWishAndLog(selectedWish, catId);
  ...
  return (
    <div className="relative min-h-screen min-h-[100dvh] pb-[calc(8rem+env(safe-area-inset-bottom,0px))] pt-8 px-4 sm:px-8 max-w-4xl mx-auto">
      ...
      <AnimatePresence>
        {selectedWish && (
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-indigo-950/40 backdrop-blur-md p-0 sm:p-4">
            <motion.div
              initial={{ y: '100%', opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              exit={{ y: '100%', opacity: 0 }}
              transition={{ type: 'spring', stiffness: 320, damping: 28 }}
              className="w-full max-w-md bg-white/95 backdrop-blur-3xl border border-white/80 rounded-t-[2.5rem] sm:rounded-[2.5rem] p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))] shadow-2xl relative overflow-hidden"
            >
              ...
              {selectedWish.status === 'fulfilled' ? (
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full p-3.5 rounded-2xl bg-amber-50 hover:bg-amber-100 border border-amber-200 text-amber-900 font-semibold text-xs flex items-center justify-between transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="w-full p-3.5 rounded-2xl bg-sky-50 hover:bg-sky-100 border border-sky-200 text-sky-900 font-semibold text-xs flex items-center justify-between transition-colors"
                  >
                    <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className="w-full p-3.5 rounded-2xl bg-indigo-900 hover:bg-indigo-800 text-white font-bold text-xs flex items-center justify-between shadow-lg transition-transform active:scale-95"
                  >
                    <div className="flex items-center gap-2.5">
