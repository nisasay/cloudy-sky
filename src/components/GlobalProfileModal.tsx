...
import { getHasEverDissolved } from './DissolvableText';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-indigo-950/40 backdrop-blur-md p-4">
        <motion.div
          ...
          className="w-full max-w-md bg-white/95 backdrop-blur-3xl border border-white/80 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden"
        >
          {/* Header */}
          ...
          <button
            onClick={handleSave}
            className="w-full py-3.5 rounded-2xl bg-indigo-900 hover:bg-indigo-800 text-white font-bold text-xs shadow-lg"
          >
            {t('profile_save')}
          </button>
        </motion.div>
